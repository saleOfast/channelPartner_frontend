...
const ConversionPercentageTable = ({ deleteConfirm, disableConfirm, dataList, openEdtMdl, title, loader }) => {

    const columns = [
        {
            name: 'conversion_amount',
            label: "Conversion Percentage Name",
            options: {
                filter: true,
            }
        },
        {
            ...
            label: "Conversion Percentage Code",
            options: {
                filter: true,
            }
        },
