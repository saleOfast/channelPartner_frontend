...
const DynamicTable = dynamic(
  () => import('./DistributorManagementTable'),
  { ssr: false }
)
    ...
    <>
      ...
      <div className={`main_Box  ${sideView}`}>
        <div className="bread_head">
          <h3 className="content_head">DISTRIBUTORS</h3>
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              <li className="breadcrumb-item"> <Link href='/dms'>Home   </Link></li>
              <li className="breadcrumb-item active" aria-current="page">Distributor List</li>
            </ol>
          </nav>
        </div>
