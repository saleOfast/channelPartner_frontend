        ...
        <>
            ...
            <div className={`main_Box  ${sideView}`}>
                <div className="bread_head">
                    <h3 className="content_head">Estimations Management</h3>
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            <li className="breadcrumb-item"> <Link href='/media'>Home </Link></li>
                            <li className="breadcrumb-item active" aria-current="page">Estimations List</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div className="table_screen">
                        <div className="top_btn_sec">
                            <div className="d-flex">
                                <Link href='/media/AddEstimations'>
