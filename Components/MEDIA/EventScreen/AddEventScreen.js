      ...
      <div className="bread_head">
        ...
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item fw-bolder">
              <Link href="/media/EventScreen"> Event List </Link>
            </li>
        ...
        <div className="Add_user_screen">
          ...
          <div className="row add_user_form">
            ...
            {contactInfo.event_type == "lead event" ? (
              <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                ...
                >
                  ...
                  <span className="errorText">
                    {" "}
                    {errorData?.lead_id ? errorData.lead_id : ""}
                  </span>
                </div>
              </div>
            ) : (
              <div className="col-xl-3 col-md-3 col-sm-12 col-12">
                ...
                >
                  ...
                  <span className="errorText">
                    {" "}
                    {errorData?.link_with_opportunity
                      ? errorData.link_with_opportunity
                      : ""}
                  </span>
                </div>
            ...
            <div className="col-xl-4 col-md-4 col-sm-12 col-12">
              <div
                className={
                  errorData?.call_subject ? "input_box errorBox" : "input_box"
                }
              >
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    const isValid = /^[a-zA-Z\s]*$/.test(value); // Allows only letters and spaces
                    ...
                    if (isValid) {
                      ...
                      setErrorData({
                        ...errorData,
                        call_subject: "Only letters and spaces are allowed",
                      });
                    }
                  }}
                  value={
                    contactInfo.call_subject ? contactInfo.call_subject : ""
                  }
                />
                <span className="errorText">
                  {" "}
                  {errorData?.call_subject ? errorData.call_subject : ""}
                </span>
              </div>
            </div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (isValid) {
                      ...
                      setErrorData({ ...errorData, contact_person_name: "" }); // Clear any previous error
                    } else {
                      setErrorData({
                        ...errorData,
                        contact_person_name:
            ...
            <div className="col-xl-4 col-md-4 col-sm-12 col-12">
              <div className="input_box">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (isValid) {
                      ...
                      setErrorData({ ...errorData, relate_to: "" }); // Clear any previous error
                    } else {
                      setErrorData({
                        ...errorData,
                        relate_to: "Only letters and spaces are allowed",
                      });
                    }
                  }}
                ...
                />
                <span className="errorText">
                  {errorData?.relate_to ? errorData.relate_to : ""}
                </span>
              </div>
            </div>
                ...
                <input
                  ...
                  value={
                    contactInfo?.event_date
                      ? moment(contactInfo?.event_date).format("YYYY-MM-DD")
                      : ""
                  }
                />
                <span className="errorText">
                  {" "}
                  {errorData?.event_date ? errorData.event_date : ""}
                </span>
              </div>
            </div>
