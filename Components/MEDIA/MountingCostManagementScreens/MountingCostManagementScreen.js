...
const DynamicTable = dynamic(
  () => import('./CostManagementTable'),
  { ssr: false }
)
//MountingCostManagementScreens
const MountingCostManagementScreens = () => {
  ...
  async function deleteHandler() {
    if (hasCookie("token")) {
      ...
      try {
        const response = await axios.delete( Baseurl + `/db/media/mountingCost/deleteMountingCost?mo_c_id=${currObj}`, header);
  ...
  const handleDownload = async () => {
    if (hasCookie("token")) {
      ...
      try {
        const response = await axios.get(Baseurl + `/db/media/mountingCost/getMountingCost/download`, header);
        ...
        <div className="main_content">
          <div className="table_screen">
            ...
            <div className="d-flex">
              <Link href='/media/AddMountingCost'>
...
export default MountingCostManagementScreens