            ...
            <div className="bread_head">
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item">
                            <Link href="/media/Opportunity"> Opportunity </Link>
                        </li>
                    ...
                    {errorData?.contact_id
                      ...
                      : ""}
                            ...
                            <div className={errorData?.conversion_perc ? 'input_box errorBox' : 'input_box'}>
                                ...
                                id="conversion_perc"
                                className={errorData?.conversion_perc ? 'form-control is-invalid' : 'form-control'}
                                onChange={(e) => {
                                    const value = e.target.value;
                                    // Allow only digits, ensure the length is up to 3 digits, and not greater than 100
                                    if (/^\d{0,3}$/.test(value) && (value === '' || parseInt(value) <= 100)) {
                                    setUserInfo({ ...userInfo, conversion_perc: value });
                      ...
                      <div className="addFieldsForm py-5">
                        ...
                        <div className="text-end">
                            ...
                            <span className="text_bold"><button className='btn btn-primary ' onClick={AddFieldsFunc}> Add More Fields</button>  </span>
                                ...
                                <Link href="/media/Opportunity"><button className="btn btn-cancel m-3 " >Cancel</button></Link>
                                {editMode ? (
