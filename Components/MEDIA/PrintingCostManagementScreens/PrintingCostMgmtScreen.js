...
const DynamicTable = dynamic(
    () => import('./PrintingCostTable'),
    { ssr: false }
)

const PrintingCostMgmtScreen = () => {
        ...
        if (hasCookie("token")) {
          ...
          try {
           ...
           if(response?.status==200){
            ...
            downloadLink.setAttribute("download", "Accounts.xlsx");
        ...
        <>
            ...
            <div className={`main_Box  ${sideView}`}>
                <div className="bread_head">
                    <h3 className="content_head">Printing Cost Management</h3>
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            <li className="breadcrumb-item"> <Link href='/media'>Home </Link></li>
                            <li className="breadcrumb-item active" aria-current="page">Printing Cost List</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div className="table_screen">
                        <div className="top_btn_sec">
                            <div className="d-flex">
                                <Link href='/media/AddPrintingCost'>
...
export default PrintingCostMgmtScreen