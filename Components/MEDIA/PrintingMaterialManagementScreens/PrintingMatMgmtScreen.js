...
const DynamicTable = dynamic(
  () => import('./PrintingMatMgmtTab'),
  { ssr: false }
)

const PrintingMatMgmtScreen = () => {
    ...
    <>
      ...
      <div className={`main_Box  ${sideView}`}>
        <div className="bread_head">
          <h3 className="content_head">PRINTING MATERIAL MANAGEMENT</h3>
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              <li className="breadcrumb-item">
                <Link href="/media">Home </Link>
              </li>
              <li className="breadcrumb-item"> Printing Material Management</li>
            </ol>
          </nav>
        </div>
      ...
      <Modal className="commonModal" show={show} onHide={handleClose} >
        <Modal.Header closeButton>
          <Modal.Title> {editMode ? 'EDIT' : ' ADD'} Printing Material</Modal.Title>
        </Modal.Header>
        <Modal.Body>
            ...
            <div className="row">
              <div className="col-xl-12 col-md-12 col-sm-12 col-12">
                <div className="input_box">
                  <label htmlFor="email">Printing Material Name</label>
                  <input
                    type="text"
...
export default PrintingMatMgmtScreen;
