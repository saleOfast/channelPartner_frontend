      ...
      <div className="bread_head">
        ...
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item fw-bolder">
              <Link href="/media/TaskScreen"> Tasks List </Link>
            </li>
                  ...
                  <div className={errorData?.task_name ? 'input_box errorBox' : 'input_box'}>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (isValid) {
                          setUserInfo({ ...userInfo, task_name: value });
                          setErrorData({ ...errorData, task_name: '' });
                        } else {
                          setErrorData({
                            ...errorData,
                            task_name: 'Only letters and spaces are allowed',
                          });
                        }
                      }}
            ...
            <div className="add_user_form">
              ...
              <div className="text-end">
                <div className="submit_btn">
                  {viewMode ? null : <>
                    <Link href='/media/TaskScreen'><button className="btn btn-cancel m-3 ">Cancel</button></Link>
                    {editMode ? (
