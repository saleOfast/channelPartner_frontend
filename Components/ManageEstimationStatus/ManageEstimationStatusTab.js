...
const ManageEstimationStatusTab = ({ deleteConfirm, disableConfirm, dataList, openEdtMdl, title, loader }) => {

  const columns = [
    {
      name: 'est_s_name',
      label: "Estimation Status Name",
      options: {
        filter: true,
      }
    },
...
export default ManageEstimationStatusTab 