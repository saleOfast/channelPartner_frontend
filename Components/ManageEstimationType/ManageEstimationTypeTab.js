...
const ManageEstimationTypeTab = ({ deleteConfirm, disableConfirm, dataList, openEdtMdl, title, loader }) => {

  const columns = [
    {
      name: 'est_t_name',
      label: "Estimation Type Name",
      options: {
        filter: true,
      }
    },
...
export default ManageEstimationTypeTab 