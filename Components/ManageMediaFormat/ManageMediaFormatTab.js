...
const ManageMediaFormatTab = ({ deleteConfirm, disableConfirm, dataList, openEdtMdl, title, loader }) => {

  const columns = [
    {
      name: 'm_f_name',
      label: "Media Format Name",
      options: {
        filter: true,
      }
    },
...
export default ManageMediaFormatTab 