...
const DynamicTable = dynamic(
  () => import('./ManageSiteCategoryTab'),
  { ssr: false }
)

const ManageSiteCategoryScreen = () => {
    ...
    <>
      ...
      <div className={`main_Box  ${sideView}`}>
        <div className="bread_head">
          <h3 className="content_head">SITE CATEGORY MASTER</h3>
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb">
              <li className="breadcrumb-item">
                <Link href="/setting">Home </Link>
              </li>
              <li className="breadcrumb-item"> Site Category Master</li>
            </ol>
          </nav>
        </div>
      ...
      <Modal className="commonModal" show={show} onHide={handleClose} >
        <Modal.Header closeButton>
          <Modal.Title> {editMode ? 'EDIT' : ' ADD'} SITE CATEGORY</Modal.Title>
        </Modal.Header>
        <Modal.Body>
            ...
            <div className="row">
              <div className="col-xl-12 col-md-12 col-sm-12 col-12">
                <div className="input_box">
                  <label htmlFor="email">Site Category Name</label>
                  <input
                    type="text"
                    placeholder='Enter Site Category Name'
                    name="email" id="email"
...
export default ManageSiteCategoryScreen;
