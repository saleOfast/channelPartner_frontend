...
const ManageSiteStatusTab = ({ deleteConfirm, disableConfirm, dataList, openEdtMdl, title, loader }) => {

  const columns = [
    {
      name: 's_s_name',
      label: "Site Status Name",
      options: {
        filter: true,
      }
    },
...
export default ManageSiteStatusTab 