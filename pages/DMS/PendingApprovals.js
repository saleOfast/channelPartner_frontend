...
import PendingApprovalManagementScreen from '../../Components/DMS_WEB/PendingApprovalManagement/PendingApprovalManagementScreen';
function PendingApprovals() {
    ...
    return (
        <>
            <PendingApprovalManagementScreen/>
        </>
    )
}
